...
},m.prototype.usgTopo="__USG__",m.prototype.uzbTopo="__UZB__",m.prototype.vatTopo="__VAT__",m.prototype.vctTopo="__VCT__",m.prototype.venTopo="__VEN__",m.prototype.vgbTopo="__VGB__",m.prototype.virTopo="__VIR__",m.prototype.vnmTopo="__VNM__",m.prototype.vutTopo="__VUT__",m.prototype.wlfTopo="__WLF__",m.prototype.wsbTopo="__WSB__",m.prototype.wsmTopo="__WSM__",m.prototype.yemTopo="__YEM__",m.prototype.zafTopo="__ZAF__",m.prototype.zmbTopo="__ZMB__",m.prototype.zweTopo="__ZWE__",m.prototype.latLngToXY=function(a,b){return this.projection([b,a])},m.prototype.addLayer=function(a,b,c){var d;return d=c?this.svg.insert("g",":first-child"):this.svg.append("g"),d.attr("id",b||"").attr("class",a||"")},m.prototype.updateChoropleth=function(a,b){var c=this.svg;this.data=a,b&&b.reset===!0&&c.selectAll(".datamaps-subunit").attr("data-info",function(){return"{}"}).transition().style("fill",this.options.fills.defaultFill);for(var d in a)this.renderSubunit(d)},m.prototype.renderSubunit=function(a){var b=this.options.fills.defaultFill;if(a&&this.data&&this.data.hasOwnProperty(a)){var c=this.data[a];if(b="string"==typeof c?c:"string"==typeof c.color?c.color:"string"==typeof c.fillColor?c.fillColor:this.options.fills[c.fillKey],c===Object(c)){this.options.data[a]=l(c,this.options.data[a]||{});this.svg.select("."+a).attr("data-info",JSON.stringify(this.options.data[a]))}}this.svg.selectAll("."+a).transition().style("stroke",null).style("stroke-width",null).style("fill-opacity").style("fill",b)},m.prototype.updatePopup=function(a,b,c){var d=this;a.on("mousemove",null),a.on("mousemove",function(){var e=n.mouse(d.options.element),f=d.options.element.getBoundingClientRect(),g=f.width,h=f.height,i=2*e[1]<h,j=2*e[0]<g,k={top:i?e[1]+20+"px":"auto",left:j?e[0]+20+"px":"auto",bottom:i?"auto":h-e[1]+20+"px",right:j?"auto":g-e[0]+20+"px"};n.select(d.svg[0][0].parentNode).select(".datamaps-hoverover").html(function(){var d=JSON.parse(a.attr("data-info"));try{return c.popupTemplate(b,d)}catch(e){return""}}).style(k)}),n.select(d.svg[0][0].parentNode).select(".datamaps-hoverover").style("display","block")},m.prototype.addPlugin=function(a,b){var c=this;"undefined"==typeof m.prototype[a]&&(m.prototype[a]=function(d,e,f,g){var h;"undefined"==typeof g&&(g=!1),"function"==typeof e&&(f=e,e=void 0),e=l(e||{},c.options[a+"Config"]),!g&&this.options[a+"Layer"]?(h=this.options[a+"Layer"],e=e||this.options[a+"Options"]):(h=this.addLayer(a),this.options[a+"Layer"]=h,this.options[a+"Options"]=e),b.apply(this,[h,d,e]),f&&f(h)})},"object"==typeof exports?(n=require("d3"),o=require("topojson"),module.exports=m):"function"==typeof define&&define.amd?define("datamaps",["require","d3","topojson"],function(a){return n=a("d3"),o=a("topojson"),m}):window.Datamap=window.Datamaps=m,window.jQuery&&(window.jQuery.fn.datamaps=function(a,b){a=a||{},a.element=this[0];var c=new m(a);return"function"==typeof b&&b(c,a),this})}();